...
function RejectedStudentLeaveApplication() {
    const [leaveData,setLeaveData] = useState([])
    const teacher_class = useSelector(state=>state.auth.data.teacher_class)
    useEffect(()=>{
        axios.post('http://localhost:8002/api/v1/teachers/students/allRejected',{
            teacher_class
        },{
            headers:{
  ...
  return (
    <div><div className='flex flex-col h-screen m-2 mt-0 bg-neutral-100 rounded-lg p-2'>
    <div className='flex text-2xl p-2 items-center justify-center'>Rejected Applications</div>
    <div className=' '>
...
export default RejectedStudentLeaveApplication