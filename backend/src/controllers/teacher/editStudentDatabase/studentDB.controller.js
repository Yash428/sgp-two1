...
const getStudentPasswordByClass = asyncHandler(async(req,res)=>{
    ...
    const result = await sequelize.query("select s.student_id,s.student_password from student as s inner join teacher as t on t.teacher_class = s.student_class and s.student_class = ?;",{
